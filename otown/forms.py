...
class UserForm(ModelForm):
    class Meta:
        model = User 
        fields = ['username', 'name', 'email', 'phone', 'avatar' ,'bio', 'twitter', 'linkedin', 'facebook', 'github', 'website']    
        widgets = {
            ...
            'phone':forms.TextInput(attrs={'class':'form-field--input'}),
...
class CustomUserCreateForm(UserCreationForm):
    class Meta:
        model = User
        fields = ['username', 'email', 'phone', 'name', 'password1', 'password2', 'avatar']
        widgets = {
            'username': forms.TextInput(attrs={'class':'form-field--input'}),
            'name':forms.TextInput(attrs={'class':'form-field--input'}),
            'email':forms.EmailInput(attrs={'class':'form-field--input'}),
